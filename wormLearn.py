...
#chemical signal
#every neurons wants to get activated, if a neuron does not get activated it dies
#4 inputs 1 hour, 24hours, 1week bitcoin price movement, 1 week google trend at sensor neurons
#t+1week price movement in the past
#Global reward +positive strengthen of the synapses
#Global punishment -negative strengthening of the synapes
#1 positive 1 week prediction for price movement
#1 negative 1 week prediction for price movement

#route of backpropogation different from that of forward input feed

#if buy/sell weighting close to 1 weeks price movement, reward

#output/feedback t+1week price movement at motor neuron
